<template>
  <svg fill="currentColor" preserveAspectRatio="xMidYMid meet" height="100%" width="100%" viewBox="0 0 512 512">
    <defs>
      <symbol id="thunderstorm-b" viewBox="0 0 214.3 140.1">
      ...
      <symbol id="thunderstorm-c" viewBox="0 0 359 231">
      ...
      <symbol id="thunderstorm-d" viewBox="0 0 447.7 371.5">
        <g clip-path="url(#thunderstorm-a)">
          <use xlink:href="#thunderstorm-b" width="214.3" height="140.1" transform="translate(195.51 165.01)"/>
        </g>
        <use xlink:href="#thunderstorm-c" width="359" height="231" transform="translate(0 140.5)"/>
      </symbol>
      <symbol id="thunderstorm-e" viewBox="0 0 96 176">
        <path fill="#f6a823" d="M32 0 0 96h32l-16 80L96 64H48L80 0H32z"/>
      </symbol>
      <clipPath id="thunderstorm-a">
        <path fill="none" d="M351.5 308a56 56 0 00-56-56l-2.5.1A83.7 83.7 0 00211.5 148V0h236.2v308Z"/>
      </clipPath>
    </defs>
    <use xlink:href="#thunderstorm-d" width="447.7" height="371.5" transform="translate(64.34)"/>
    <use xlink:href="#thunderstorm-e" width="96" height="176" transform="translate(208 293)"/>
  </svg>
</template>
